...
.allweb {
  height: 100%;
  width: 100%;
	background: url('https://www.laowaicang.com/avatar-bici.png') center -250px no-repeat;
					...
					<i-col :span="spanLeft" class="layout-menu-left">
						<Menu active-key="1" theme="dark" width="auto">
							...
							<div v-if="login=='all'">
								...
								<Menu-item name="11">
									<Icon type="ios-email-outline"></Icon>
									<router-link to='/user' tag='span'>用户模块</router-link>
								</Menu-item>
								<Menu-item name="12">
									<Icon type="ios-copy-outline"></Icon>
									<router-link to='/warehouse' tag='span'>仓库</router-link>
								</Menu-item>
								<Menu-item name="13">
									<Icon type="ios-copy-outline"></Icon>
									<router-link to='/indent' tag='span'>订单</router-link>
								</Menu-item>
							</div>
							<!-- <div v-if="login=='news'">
								<Submenu name="3">

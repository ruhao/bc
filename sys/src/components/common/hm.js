...
export default {
    ...
    methods: {
        ...
        getData() {
            this.$http.post(`https://www.laowaicang.com/${this.apimodel}/list`, this.fliter).then(res => {
        ...
        remove(index) {
            this.$Modal.confirm({
                ...
                onOk: () => {
                    setTimeout(() => {
                        this.$http.delete(`https://www.laowaicang.com/${this.apimodel}/data/` + this.fliter.data6[index]._id).then(res => {
                            //通过传入的id来删除需要删除的内容
        ...
        handleSubmit() {
            ...
            this.$http.post( `https://www.laowaicang.com/${this.apimodel}/data`, this.formValidate).then(res => {
                console.log(res)
                this.getData()
                this.modal6 = false;

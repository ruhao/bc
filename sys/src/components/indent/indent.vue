<template>
	<div class="content">
		...
		<Modal v-model="modal6" title="订单生成" :loading="loading" @on-ok="asyncOK">
			<Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
				<FormItem label="产品">
					<Input v-model="formValidate.name" placeholder="Enter your name"></Input>
				</FormItem>
        <FormItem label="数量">
					<Input v-model="formValidate.num" type="textarea" placeholder="Enter your num"></Input>
				</FormItem>
        <FormItem label="电话">
					<Input v-model="formValidate.telephone" placeholder="Enter your telepone"></Input>
				</FormItem>
				<FormItem label="地址">
					<Input v-model="formValidate.area" type="textarea"  placeholder="Enter your area"></Input>
				</FormItem>
				<FormItem>
...
export default {
  ...
  data() {
    return {
      type: "2",
      apimodel: "indent", //resful api 接口路径不同处
      columns7: [
        {
          //ui框架的表格创建
          type: "selection",
